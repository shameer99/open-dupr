...
const MatchCard: React.FC<MatchCardProps> = ({
  ...
  return (
    <div
      className="group border rounded-lg p-3 cursor-pointer transition-all hover:border-primary/30 hover:bg-accent/20"
      onClick={() => {
    ...
    >
      <div className="flex items-center justify-between text-xs text-muted-foreground mb-2">
        ...
        {match.eventDate && <span className="text-xs">{match.eventDate}</span>}
      </div>
